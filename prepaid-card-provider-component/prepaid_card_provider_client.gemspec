...
Gem::Specification.new do |s|
  s.name = 'prepaid_card_provider-client'
  s.version = '0.0.0'
  ...
  files = Dir["lib/prepaid_card_provider/**/*.rb"]

  files += Dir["lib/prepaid_card_provider_component/{controls.rb,controls/**/*.rb}"]

  files << "lib/prepaid_card_provider_component/load.rb"

  File.read("lib/prepaid_card_provider_component/load.rb").each_line.map do |line|
    next if line == "\n"
