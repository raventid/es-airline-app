...
module PrepaidCardProviderComponent
  class Projection
    ...
    entity_name :prepaid_card_provider

    # TODO Implement event projection blocks
    # eg:
    # apply SomethingHappened do |something_happened|
    #   SetAttributes.(prepaid_card_provider, something_happened, copy: [
    #     { :prepaid_card_provider_id => :id }
    #   ])

    #   something_happened_time = Clock.parse(something_happened.time)

    #   prepaid_card_provider.something_happened_time = something_happened_time
    # end
  end
end
